...
count_per_neighbourhood = count_per_neighbourhood.sort_values(by='Nombre de Biens', ascending=False)
fig = px.bar(count_per_neighbourhood, x='Quartier', y='Nombre de Biens',
